        ...
        <tr>
            ...
            <td>
                <?php
                    ...
                    $cadenaEstatus = '<span class="badge badge-danger">En espera</span>';
                    if ($estatus == 0) {
                        $cadenaEstatus = '<span class="badge badge-success">Solucionado</span>';
                    }
                    echo $cadenaEstatus;
                ?>
            </td>
...
<!--Para generar los reportes en formato csv, exceñ y pdf -->
<script>
