...
<!-- Modal para asignar los equipos mediante formularios-->
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <?php
                        ...
                        /*En este apartado se busca al usuario creado*/ 

                        /*Comando del SQL para que solo acepta usuarios*/
                        $sql = "SELECT 
                                    persona.id_persona,
                ...
                <div class="col-sm-6">
                    ...
                    <?php
                        ...
                        $respuesta = mysqli_query($conexion, $sql);
                    ?>
                    <!--Este apartado es para buscar el tipo de equipo de la base de datos-->
